...
import { ListGetNamesResponseResultsInner } from './list-get-names-response-results-inner';

/**
 * 
 * @export
 * @interface ListGetNamesResponse
 */
export interface ListGetNamesResponse {
    /**
     * 
     * @type {string}
     * @memberof ListGetNamesResponse
     */
    'status'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ListGetNamesResponseResultsInner>}
     * @memberof ListGetNamesResponse
     */
    'results'?: Array<ListGetNamesResponseResultsInner>;
}
