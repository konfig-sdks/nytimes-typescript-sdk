 ...
 * 
 * @export
 * @interface ListGetBestSellersResponseResultsInnerReviewsInner
 */
export interface ListGetBestSellersResponseResultsInnerReviewsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetBestSellersResponseResultsInnerReviewsInner
     */
