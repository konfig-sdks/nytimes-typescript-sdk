...
import { ListGetBestSellersResponseResultsInner } from './list-get-best-sellers-response-results-inner';

/**
 * 
 * @export
 * @interface ListGetBestSellersResponse
 */
export interface ListGetBestSellersResponse {
    /**
     * 
     * @type {string}
     * @memberof ListGetBestSellersResponse
     */
    'status'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ListGetBestSellersResponseResultsInner>}
     * @memberof ListGetBestSellersResponse
     */
    'results'?: Array<ListGetBestSellersResponseResultsInner>;
}
