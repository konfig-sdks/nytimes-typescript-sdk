...
import { ListGetHistoryResponseResultsInner } from './list-get-history-response-results-inner';

/**
 * 
 * @export
 * @interface ListGetHistoryResponse
 */
export interface ListGetHistoryResponse {
    /**
     * 
     * @type {string}
     * @memberof ListGetHistoryResponse
     */
    'status'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ListGetHistoryResponseResultsInner>}
     * @memberof ListGetHistoryResponse
     */
    'results'?: Array<ListGetHistoryResponseResultsInner>;
}
