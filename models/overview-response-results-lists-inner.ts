...
import { OverviewResponseResultsListsInnerBooksInner } from './overview-response-results-lists-inner-books-inner';

/**
 * 
 * @export
 * @interface OverviewResponseResultsListsInner
 */
export interface OverviewResponseResultsListsInner {
    /**
     * 
     * @type {number}
     * @memberof OverviewResponseResultsListsInner
     */
    'list_id'?: number;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<OverviewResponseResultsListsInnerBooksInner>}
     * @memberof OverviewResponseResultsListsInner
     */
    'books'?: Array<OverviewResponseResultsListsInnerBooksInner>;
}
