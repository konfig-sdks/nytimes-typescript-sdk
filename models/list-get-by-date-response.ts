...
import { ListGetByDateResponseResults } from './list-get-by-date-response-results';

/**
 * 
 * @export
 * @interface ListGetByDateResponse
 */
export interface ListGetByDateResponse {
    /**
     * 
     * @type {string}
     * @memberof ListGetByDateResponse
     */
    'status'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {ListGetByDateResponseResults}
     * @memberof ListGetByDateResponse
     */
