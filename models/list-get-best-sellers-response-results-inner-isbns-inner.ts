 ...
 * 
 * @export
 * @interface ListGetBestSellersResponseResultsInnerIsbnsInner
 */
export interface ListGetBestSellersResponseResultsInnerIsbnsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetBestSellersResponseResultsInnerIsbnsInner
     */
    'isbn10'?: string;
    /**
     * 
