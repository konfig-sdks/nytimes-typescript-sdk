 ...
 * 
 * @export
 * @interface ListGetBestSellersResponseResultsInnerBookDetailsInner
 */
export interface ListGetBestSellersResponseResultsInnerBookDetailsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetBestSellersResponseResultsInnerBookDetailsInner
     */
    'title'?: string;
    /**
     * 
