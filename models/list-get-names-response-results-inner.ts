 ...
 * 
 * @export
 * @interface ListGetNamesResponseResultsInner
 */
export interface ListGetNamesResponseResultsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetNamesResponseResultsInner
     */
    'list_name'?: string;
    /**
     * 
     ...
     * @memberof ListGetNamesResponseResultsInner
     */
    'updated'?: ListGetNamesResponseResultsInnerUpdatedEnum;
}

type ListGetNamesResponseResultsInnerUpdatedEnum = 'WEEKLY' | 'MONTHLY'
