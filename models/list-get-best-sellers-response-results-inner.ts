...
import { ListGetBestSellersResponseResultsInnerBookDetailsInner } from './list-get-best-sellers-response-results-inner-book-details-inner';
import { ListGetBestSellersResponseResultsInnerIsbnsInner } from './list-get-best-sellers-response-results-inner-isbns-inner';
import { ListGetBestSellersResponseResultsInnerReviewsInner } from './list-get-best-sellers-response-results-inner-reviews-inner';

/**
 * 
 * @export
 * @interface ListGetBestSellersResponseResultsInner
 */
export interface ListGetBestSellersResponseResultsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetBestSellersResponseResultsInner
     */
    'list_name'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ListGetBestSellersResponseResultsInnerBookDetailsInner>}
     * @memberof ListGetBestSellersResponseResultsInner
     */
    'book_details'?: Array<ListGetBestSellersResponseResultsInnerBookDetailsInner>;
    /**
     * 
     * @type {Array<ListGetBestSellersResponseResultsInnerReviewsInner>}
     * @memberof ListGetBestSellersResponseResultsInner
     */
    'reviews'?: Array<ListGetBestSellersResponseResultsInnerReviewsInner>;
}
