...
import { ReviewGetBookReviewsResponseResultsInner } from './review-get-book-reviews-response-results-inner';

/**
 * 
 * @export
 * @interface ReviewGetBookReviewsResponse
 */
export interface ReviewGetBookReviewsResponse {
    /**
     * 
     * @type {string}
     * @memberof ReviewGetBookReviewsResponse
     */
    'status'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ReviewGetBookReviewsResponseResultsInner>}
     * @memberof ReviewGetBookReviewsResponse
     */
    'results'?: Array<ReviewGetBookReviewsResponseResultsInner>;
}
