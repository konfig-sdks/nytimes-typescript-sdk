...
import { ListGetHistoryResponseResultsInnerRanksHistoryInner } from './list-get-history-response-results-inner-ranks-history-inner';

/**
 * 
 * @export
 * @interface ListGetHistoryResponseResultsInner
 */
export interface ListGetHistoryResponseResultsInner {
    /**
     * 
     * @type {string}
     * @memberof ListGetHistoryResponseResultsInner
     */
    'title'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ListGetHistoryResponseResultsInnerRanksHistoryInner>}
     * @memberof ListGetHistoryResponseResultsInner
     */
    'ranks_history'?: Array<ListGetHistoryResponseResultsInnerRanksHistoryInner>;
    /**
     * 
